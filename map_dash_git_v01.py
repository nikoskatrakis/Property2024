...
app.layout = html.Div([
    ...
    dl.Map(children=[dl.TileLayer()] + initial_markers, style={'width': '100%', 'height': '80vh'}, center=[52.7, -0.11], zoom = 7, id="map"),
...
#            print("you did something and I ended up in the if new_merkers_data.empty line")
            return children, "No data available for this marker!", dash.no_update, dash.no_update, current_marker_ids
